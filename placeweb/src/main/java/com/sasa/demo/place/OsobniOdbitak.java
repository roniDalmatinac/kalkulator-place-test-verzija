...
public class OsobniOdbitak  {
	...
	protected static double dohodakNakonMirovinskog;
	protected static double placaNeto;
	protected static double ukupniPrirez;
	...
	public static double ukupniOdbitak(int brClanova, int brDjece) {
	...
	public static double getUkupniPrirez() {
		return ukupniPrirez;
	}

	public static void setUkupniPrirez(double ukupniPrirez) {
